    ...
    <div class="template-page-wrapper">
      <div class="navbar-collapse collapse templatemo-sidebar">
        <ul class="templatemo-sidebar-menu">
          ...
          <li class="active"><a href="/admin/dashboard"><i class="fa fa-home"></i>Dashboard</a></li>
          <li><a href="/admin/employee_list"><i class="fa fa-cubes"></i>Employee List</a></li>
          <li><a href="/admin/employee_approver"><i class="fa fa-map-marker"></i>Employee Approver</a></li>
